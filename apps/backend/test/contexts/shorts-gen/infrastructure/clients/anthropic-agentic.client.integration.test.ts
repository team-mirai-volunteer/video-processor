...
import { AnthropicAgenticClient } from '../../../../../src/contexts/shorts-gen/infrastructure/clients/anthropic-agentic.client.js';
...
const runIntegrationTests = process.env.INTEGRATION_TEST === 'true' && isAnthropicConfigured();

describe.skipIf(!runIntegrationTests)('AnthropicAgenticClient Integration', () => {
  let client: AnthropicAgenticClient;

  beforeAll(() => {
    client = new AnthropicAgenticClient();
  });
...
describe('AnthropicAgenticClient Unit', () => {
  it('should throw error if ANTHROPIC_API_KEY is not set', () => {
    const originalKey = process.env.ANTHROPIC_API_KEY;
    process.env.ANTHROPIC_API_KEY = '';

    expect(() => new AnthropicAgenticClient()).toThrow(
  ...
  it('should use provided model name', () => {
    ...
    const client = new AnthropicAgenticClient('claude-3-haiku-20240307');
